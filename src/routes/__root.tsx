...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      // Sitewide fallbacks only. Page-specific title / description /
      // og:* live in each leaf route's head() so they can override.
      { name: "theme-color", content: "#0b1120" },
      { name: "format-detection", content: "telephone=no" },
      { property: "og:site_name", content: "Crypto Portfolio Tracker" },
    ...
    links: [
      ...
      // Cut TLS/DNS latency for the runtime price provider.
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Local-first crypto portfolio tracker with live CoinGecko prices, P&L, allocation charts, CSV/JSON import & export.",
        }),
      },
    ],
  }),
